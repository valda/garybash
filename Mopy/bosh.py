...
class GmstTweaker(MultiTweaker):
    ...
    tweaks = sorted([
        ...
        #     ),
        #--Maximum Armor Rating
        GmstTweak(_('Combat: Gun Spread Run Multiplier'),
            _("The multiplier which bullet spread when running."),
            'fGunSpreadRunMult',
            ('[0.0]',0.0),
            ('0.1',0.1),
            ('0.2',0.2),
        ...
        GmstTweak(_('Combat: Gun Spread Crouch Multiplier'),
            _("The multiplier which bullet spread when crouching."),
